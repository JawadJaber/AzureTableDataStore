...
namespace AzureTableDataStore
{
    public class AzureStorageUtils
    {
        ...
        public static (string accountName, string accountKey) GetAccountNameAndKeyFromConnectionString(string connectionString)
        {
        ...
        public static string GetStorageUriFromConnectionString(string connectionString, CredentialType credentialType)
        {
            try
            {
                var connectionStringValues = connectionString.Split(';')
        ...
        public static StorageSharedKeyCredential GetStorageSharedKeyCredentialFromConnectionString(string connectionString)
        {
